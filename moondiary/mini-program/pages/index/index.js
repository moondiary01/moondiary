      ...
      if (mdData && mdData.dailyRecords) {
        for (var mdi = 0; mdi < mdData.dailyRecords.length; mdi++) {
          ...
          if (mrec.date === todayStr) {
            ...
            if (mrec.discipline) {
              var discLabelMap = {tidyRoom:'收拾房间',declutter:'断舍离',read:'阅读',exercise:'运动',cook:'做饭',noPhone:'减少手机',earlySleep:'早睡',gratitude:'感恩记录',meditation:'冥想',skincare:'护肤',water:'喝水',journal:'写日记'};
              var discItems = [];
